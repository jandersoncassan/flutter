...
class UploadService {
  static Future<ResponseApi<String>> upload(File file) async {
    try {
      ...
      return ResponseApi.ok(map["url"]);

    } catch (e) {
      return ResponseApi.error("Não foi possível efetuar o upload da foto");
    }
  }
